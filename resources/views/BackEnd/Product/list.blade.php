                                    ...
                                    <div class="tab-pane active" id="tab-1">
                                        <div class="table-responsive">
                                            <table id="data_load" style="width: 100%;"
                                                ...
                                                <tfoot>
                                                    <tr style="text-transform: capitalize;">
                                                        <th><input type="checkbox" id="checkAll_footer">
                                                        <th>Tên</th>
                                                         <th>thư viện ảnh</th>
                                                         <th>Hình ảnh</th>
                                                         <th>Số lượng</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit','#formsample',function(e){
                ...
                var product_price = $('#change_price').val();
                var product_price_sale = $('#promotion_price').val();
                ...
                data.append('promotion_price_sale', promotion_price);
