            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <img alt="image" class="rounded-circle" src="{{ asset('backend/admin.png') }}" height="48px" width="48px" />
     ...
     <div class="modal inmodal" id="Modal_edit_profile" tabindex="-1" role="dialog" aria-hidden="true">
         ...
         <div class="modal-content hoạt hình bounceInRight">
                 <div class="modal-header">
                     ...
                     <img src="{{ asset('backend/admin.png') }}" alt="" class="modal-icon img-thumbnail" width="80px" height="80px">
